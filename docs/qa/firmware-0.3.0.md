...
- Badge pairing/game instructions fit its 300-pixel text area. Removed the clipped three-spell instructions and technical footer; USB `id`, `status` and `trace` still provide diagnostics.
...
| --- | ---: | --- | --- |
| `firmware/.pio/build/badge/firmware.bin` | 687,792 | `1e5418bc21de5e70c024d5988076dd5a7675496995dd589cb4f1306e2ec083cc` | App only, offset `0x10000`, inside existing `0x2a0000` factory slot |
