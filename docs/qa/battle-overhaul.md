...
- Dhairya asked for a creature-battle feel: every spell should look and move differently,
  ...
  and a little randomness should keep judges busy. Work sits on branch `feat/battle-overhaul`,
  uncommitted, for diff review.
...
- Relics: first at 8–14 s after the round starts, then 12–20 s after each claim/expiry, each
  ...
  cooldowns; Bezoar +20 HP and cures burn/stun; Felix Felicis next hit critical; Mirror Charm
