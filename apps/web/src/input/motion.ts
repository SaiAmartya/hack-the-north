...
// profile: any firm stroke, any held raise.
...
export class MotionRecognizer {
  ...
  useDefaultProfile(generation: number): void {
    ...
    this.templates.set("stupefy", { kind: "impulse", traces: [], peak: DEFAULT_IMPULSE_PEAK_MG, acceptanceDistance: DTW_MAX_ACCEPTANCE_DISTANCE });
