...
// IDs 5-7 remain reserved for the historical seven-spell firmware.
enum Spell : uint8_t { SP_NONE = 0, SP_STUPEFY = 1, SP_PROTEGO = 2, SP_EXPELLIARMUS = 3, SP_INCENDIO = 4, SP_EPISKEY = 8 };
