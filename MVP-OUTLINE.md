...
**Team interface:** [BADGE-FIRMWARE-CONTRACT.md](BADGE-FIRMWARE-CONTRACT.md) defines the required badge behavior and v1 bytes. Firmware repairs build on teammate main `6a50929`; badge and physical iPhone are player options. Raw synthetic replay remains script-only QA, never a player control. Both teams must acknowledge interface changes. See [current connectivity review and measurements](docs/qa/connectivity-stabilization.md); historical firmware results do not qualify a newer image.
