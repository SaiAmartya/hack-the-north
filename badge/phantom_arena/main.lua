-- Phantom Arena bootstrap. Bluetooth needs a clean heap (about 50 KB), so the radio starts
-- FIRST, then game.lua is compiled into what is left. All game code lives in game.lua.
